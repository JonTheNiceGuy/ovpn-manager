...
def app(test_ca, tmp_path_factory):
    ...
    (optionsets_dir / "default.opts").write_text("{# This is the default, it sets nothing #}# Load default")
    (optionsets_dir / "UseTCP.opts").write_text("{% set protocol = 'tcp-client' %}# Load TCP")
